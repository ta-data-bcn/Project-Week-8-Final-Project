...
def get_jobs(ext, keyword, location, verbose):
    ...
    time.sleep(5)
    try:
        kword = driver.find_element_by_xpath('/html/body/div[3]/div/div[1]/div[1]/div/div/form/input[5]').send_keys(keyword + Keys.TAB + location + Keys.ARROW_DOWN + Keys.ENTER)
        time.sleep(2)
